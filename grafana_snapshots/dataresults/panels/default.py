    ...
    def get_FieldConfig( self, fields: dict, results: dict ) -> list:
        ...
        for field in fields:
            ...
            # copy attributes without conditions
                ...
                if fieldConfig is None or \
                    ((isinstance(fieldConfig, list) or isinstance(fieldConfig, dict) ) and len(fieldConfig)==0):
                    # may copy a field['default'] as result
                    continue
                    ...
                    for idx,field in enumerate(snapshotDataElmt['fields']):
                        ...
                        #* check the pattern matching of the transformation
                            ...
                            if re.search(pattern, name):
                                ...
                                new_fields.append(field)
                        # include is probably empty: nothing set: add everything
                        else:
                            new_fields.append(field)
